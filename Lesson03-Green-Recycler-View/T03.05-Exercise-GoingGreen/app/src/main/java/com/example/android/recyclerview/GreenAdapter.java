...
public class GreenAdapter extends RecyclerView.Adapter<GreenAdapter.NumberViewHolder> {
    ...
    public NumberViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        viewHolder.viewHolder.setText(String.format("ViewHolder index:  %d", viewHolderCount));
        ...
        viewHolderCount++;
        Log.d(TAG, String.format("number of view holders created  %d",viewHolderCount));
