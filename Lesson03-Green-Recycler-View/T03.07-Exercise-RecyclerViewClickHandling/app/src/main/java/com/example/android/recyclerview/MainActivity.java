...
public class MainActivity extends AppCompatActivity implements GreenAdapter.ListItemClickListener {
    ...
    @Override
    public void onListItemClick(int listItemClicked) {
        if (mToast != null) {
            mToast.cancel();
        }
        String toastMessage = String.format("item #%d was clicked", listItemClicked);
        mToast = Toast.makeText(this, toastMessage, toastMessage.length());
        mToast.show();

    }

    // COMPLETED  (10) Override ListItemClickListener's onListItemClick methodS
